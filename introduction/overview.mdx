...
- **65,900 spins** completed in just 48 hours — proof of extreme engagement  
- **$11,597 in total betting volume** with only **17 players** → over **$682 average volume per player in two days**  
- **$585 in house returns** generated → **5.0% realized house edge**, right in target range  
- Annualized, this pace = **$2.1M betting volume per 17 players** — showing massive scalability with real users  
- Demonstrates that even a handful of engaged players can create **casino-scale economics** when ownership incentives are aligned
...
:::note
This roadmap is a living plan. Timelines and priorities will evolve as we continue learning from players, regulators, and partners.  
Progress is also dependent on securing the resources needed to scale — but every milestone moves us closer to making House of Voi the default infrastructure for community-owned casinos.
:::
